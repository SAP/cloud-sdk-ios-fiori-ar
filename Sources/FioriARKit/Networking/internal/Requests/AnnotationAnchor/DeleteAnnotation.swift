...
extension ARService.AnnotationAnchor {
    ...
    internal enum DeleteAnnotation {
        ...
        internal static let service = APIService<Response>(id: "deleteAnnotation", tag: "annotationAnchor", method: "DELETE", path: "/scene/{sceneId}/annotationAnchor/{id}", hasBody: false)
        ...
        internal final class Request: APIRequest<Response> {
            ...
            internal init(options: Options) {
                ...
                super.init(service: DeleteAnnotation.service)
            }
        ...
        internal enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Forbidden to delete, only creator user can delete his own annotation anchor */
            case status403
