...
extension ARService.Scene {
    ...
    Return multiple scene by multiple sceneId parameter
    */
    internal enum GetScenesByIds {

        internal static let service = APIService<Response>(id: "getScenesByIds", tag: "scene", method: "GET", path: "/scene", hasBody: false)
        ...
        internal final class Request: APIRequest<Response> {
            ...
            internal init(options: Options) {
                ...
                super.init(service: GetScenesByIds.service)
            }
